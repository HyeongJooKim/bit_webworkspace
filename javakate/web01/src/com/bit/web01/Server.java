...
//			System.out.println(request);
			...
			os.write("Content-type: text/html; charset=utf-8".getBytes());//인코딩 정보 보내기
			os.write("\r\n\r\n".getBytes());//본문과 헤더정보의 구분을 위해 한 번 더 들어감
//			file=new File("www/hangle.txt");// \\ 대신 \ 하나 써도 되는 것 같다. \\는 윈도우에서만 그런 것
			//파일 주소 몰라도 갈 수 있게
			if(arr[1].equals("/")){
				arr[1]="/index.html";
				//디폴트로 띄울 파일 지정. http://192.168.0.193:8080/ 만 해도 abc.txt 내용 띄움
				//index 파일을 이런 디폴트 파일로 쓴다
			}
