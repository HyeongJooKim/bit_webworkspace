	...
	public void run() {
		...
		try {
			...
			while(true){
				...
				String msg=mem;
				System.out.println("최초mem:"+msg);
				sendMsg(msg);
				String msg2=br.readLine();
				System.out.println("받은msg:"+msg2);
			...
			System.out.println("Server run() I/O error: "+e);
		} finally {
			try {
				if(br!=null)br.close();
				if(bw!=null)bw.close();
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				System.out.println("Server socklet close error: "+e);
			}
		} 
	}
}